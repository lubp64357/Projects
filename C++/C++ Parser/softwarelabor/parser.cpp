...
Optional<EXP> Parser::parseF() {
      ...
      case THREE:
          t.nextToken();
          return just<EXP>(newInt(3));
     case FOUR:
          t.nextToken();
          return just<EXP>(newInt(4));
        case FIVE:
          t.nextToken();
          return just<EXP>(newInt(5));
    case SIX:
          t.nextToken();
          return just<EXP>(newInt(6));
    case SEVEN:
          t.nextToken();
          return just<EXP>(newInt(7));
    case EIGHT:
          t.nextToken();
          return just<EXP>(newInt(8));
    case NINE:
          t.nextToken();
          return just<EXP>(newInt(9));
